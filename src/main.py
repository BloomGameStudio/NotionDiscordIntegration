...
async def setup_discord_service(settings: Settings, session_factory) -> tuple[DiscordService, DiscordClient]:
...
async def main():
    ...
    try:
        ...
        discord_service, discord_client = await setup_discord_service(settings, async_session)
