from sqlalchemy import Column, String, DateTime, Boolean, JSON, ForeignKey, Integer, Table, func
...
class NotionDocumentModel(Base):
    ...
    def from_entity(cls, entity: NotionDocument) -> 'NotionDocumentModel':
        return cls(
            ...
            last_edited_by_id=entity.last_edited_by.id if entity.last_edited_by else None,
            title=entity.title,
            url=entity.url,
